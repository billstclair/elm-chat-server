...
Instructions for setting up, building, and running the server are in the README for the [[https://github.com/billstclair/elm-websocket-framework-server/tree/13.0.0/example/server][example/server]] directory.
